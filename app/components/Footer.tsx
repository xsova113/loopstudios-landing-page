...
const Footer = () => {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      whileInView={"show"}
      className="flex flex-col pb-14 sm:pb-4 sm:px-16 px-10 sm:flex-row sm:justify-between items-center bg-black text-white"
    >
      <div className="my-11 flex flex-col sm:flex-row">
        <div className="flex flex-col items-center text-center sm:items-start">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:text-sm md:text-base">
            <span className="cursor-pointer hover:border-b-2 border-white transition-all pb-2">
              About
            </span>
            <span className="cursor-pointer hover:border-b-2 border-white transition-all pb-2">
              Careers
      ...
      <div className="flex flex-col">
        <div className="flex gap-4 justify-center sm:justify-end sm:mb-4">
          <Image
            ...
            width={25}
            height={25}
            className="hover:border-white border-transparent border-b-2 pb-2 transition-all cursor-pointer"
          />
          <Image
